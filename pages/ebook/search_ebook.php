...
<!-- Main content -->
    ...
    <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <h2 class="text-center display-2">Search eBook</h2>
            <div class="row">
                    ...
                    <div class="input-group justify-content-center">
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($department)) {
                                if ($_SESSION['campus'] == "All") {
                                    $result = mysqli_query($con,"SELECT * FROM ebooks WHERE department_id = '$row[department_id]'");
                                $num_rows = mysqli_num_rows($result);
                                } else {
                                $result = mysqli_query($con,"SELECT * FROM ebooks WHERE campus_id = '$_SESSION[campus]' AND department_id = '$row[department_id]'");
                                $num_rows = mysqli_num_rows($result);
                                }
                                ?>
        ...
        <?php
                            if (isset($_GET['submit'])) {
                              ...
                              LEFT JOIN tbl_publishers USING(publisher_id)
                              LEFT JOIN tbl_placeofpublications USING(pop_id)
                              WHERE  campus_id = '$_SESSION[campus]' AND ( call_no LIKE '%$_GET[search]%' OR title LIKE '%$_GET[search]%' OR subject LIKE '%$_GET[search]%' OR author LIKE '%$_GET[search]%' OR accession_no LIKE '%$_GET[search]%' OR remarks LIKE '%$_GET[search]%'  OR campus LIKE '%$_GET[search]%')") or die(mysqli_error($con));
                              ...
                              LEFT JOIN tbl_publishers USING(publisher_id)
                              LEFT JOIN tbl_placeofpublications USING(pop_id)
                              WHERE  department_id = '$_SESSION[department]' AND ( call_no LIKE '%$_GET[search]%' OR title LIKE '%$_GET[search]%' OR subject LIKE '%$_GET[search]%' OR author LIKE '%$_GET[search]%' OR accession_no LIKE '%$_GET[search]%' OR remarks LIKE '%$_GET[search]%'  OR campus LIKE '%$_GET[search]%')") or die(mysqli_error($con));
