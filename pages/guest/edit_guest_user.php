          ...
          <div class="col-md-10">
            ...
            <div class="card card-body">
              ...
              <!-- form start -->
                   <div class="x_content">
<?php
  $query=mysqli_query($con,"select * from guest where guest_id='$ID'")or die(mysqli_error($con));
...
{
mysqli_query($con," UPDATE guest SET username='$username', password='$hashedPwd' WHERE guest_id = '$id' ")or die(mysqli_error($con));
echo "<script>alert('Successfully Update Info!'); window.location='guest_home.php'</script>";  
}
