          ...
          <div class="col-md-12">
            ...
            <div class="card card-body">
              <div class="card-header">
                <h3 class="col-xs-6"><span class="fa fa-book"></span> RETURNED BOOKS LIST</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
<hr>
                        ...
                        </form><a style="float: right" href="guest_returned_list.php"><button class="btn btn-info"><i class="fa fa-reply"></i> All Reports <?php // echo $count_penalty['total']; ?></button></a>
                        <div class="clearfix"></div>
